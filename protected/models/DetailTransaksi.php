...
class DetailTransaksi extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('transaksi_id, produk_id', 'required'),
			array('transaksi_id, produk_id','safe'),
			array('id, transaksi_id, produk_id', 'length', 'max'=>20),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, transaksi_id, produk_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'produk'=>array(self::BELONGS_TO,'Produk','produk_id'),
