...
class XCHtml
{
	...
	public static function css($text,$media='')
	{
		if($media!=='')
			$media=' media="'.$media.'"';
		return "<style type=\"text/css\"{$media}>/*<![CDATA[*/{$text}/*]]>*/</style>";
	}
	...
	{
		return "<script type=\"text/javascript\">/*<![CDATA[*/{$text}/*]]>*/</script>";
	}
	...
	public static function beginForm($action='',$method='post',$htmlOptions=array())
	{
		...
		if($hiddens!==array())
			$form.="".self::tag('div',array('style'=>'display:none'),implode("",$hiddens));
		return $form;
	}
	...
	public static function dropDownList($name,$select,$data,$htmlOptions=array())
	{
		...
		self::clientChange('change',$htmlOptions);
		$options="".self::listOptions($select,$data,$htmlOptions);
		$hidden='';
