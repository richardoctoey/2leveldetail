...
/**
 * XCActiveForm provides a set of methods that can help to simplify the creation
 * of complex and interactive HTML forms that are associated with data models.
 *
 * The 'beginWidget' and 'endWidget' call of XCActiveForm widget will render
 * the open and close form tags. Most other methods of XCActiveForm are wrappers
 * of the corresponding 'active' methods in {@link XCHtml}. Calling them in between
 * the 'beginWidget' and 'endWidget' calls will render text labels, input fields,
 * etc. For example, calling {@link XCActiveForm::textField}
 * would generate an input field for a specified model attribute.
 *
 * What makes XCActiveForm extremely useful is its support for data validation.
 * XCActiveForm supports data validation at three levels:
 * <ul>
 ...
 * XCActiveForm will render the error in the page back to user.</li>
 ...
 * the associated model class. XCActiveForm is designed in such a way that
 ...
 * </ul>
 *
 * XCActiveForm relies on CSS to customize the appearance of input fields
 ...
 * validating, error and success. To differentiate these states, XCActiveForm
 ...
 *
 * The following is a piece of sample view code showing how to use XCActiveForm:
 *
 * <pre>
 ...
 *     {
 *         echo XCActiveForm::validate($model);
 *         Yii::app()->end();
 *     }
 * }
 * </pre>
 ...
 * @since 1.1.1
 */
class XCActiveForm extends CWidget
{
	/**
	 * @var mixed the form action URL (see {@link XCHtml::normalizeUrl} for details about this parameter).
	...
	public $method='post';
	/**
	 * @var boolean whether to generate a stateful form (See {@link XCHtml::statefulForm}). Defaults to false.
	 */
	 ...
	 * During the validation process, XCActiveForm will set different CSS class for the container element
	 ...
	 * <li>'focus'=>'#'.XCHtml::activeId($model,'username') - $model->username input field</li>
	...
	public function init()
	{
		...
		if($this->stateful)
			echo XCHtml::statefulForm($this->action, $this->method, $this->htmlOptions);
		else
			echo XCHtml::beginForm($this->action, $this->method, $this->htmlOptions);
	}
	...
	public function run()
	{
		if(is_array($this->focus))
			$this->focus="#".XCHtml::activeId($this->focus[0],$this->focus[1]);
		...
		if(!$this->enableAjaxValidation && !$this->enableClientValidation || empty($this->attributes))
		{
			if($this->focus!==null)
			{
				...
				$cs->registerScript('XCActiveForm#focus',"
		...
		if(isset($this->clientOptions['validationUrl']) && is_array($this->clientOptions['validationUrl']))
			$options['validationUrl']=XCHtml::normalizeUrl($this->clientOptions['validationUrl']);
	 ...
	 * This is similar to {@link XCHtml::error} except that it registers the model attribute
	 * so that if its value is changed by users, an AJAX validation may be triggered.
	 * @param CModel $model the data model
	 * @param string $attribute the attribute name
	 * @param array $htmlOptions additional HTML attributes to be rendered in the container div tag.
	 * Besides all those options available in {@link XCHtml::error}, the following options are recognized in addition:
	 * <ul>
	...
	public function error($model,$attribute,$htmlOptions=array(),$enableAjaxValidation=true,$enableClientValidation=true)
	{
		...
		if(!$enableAjaxValidation && !$enableClientValidation)
			return XCHtml::error($model,$attribute,$htmlOptions);

		$id=XCHtml::activeId($model,$attribute);
		...
		$html=XCHtml::error($model,$attribute,$htmlOptions);
		if($html==='')
		{
			...
			$html=XCHtml::tag('div',$htmlOptions,'');
		}
	 ...
	 * This method is very similar to {@link XCHtml::errorSummary} except that it also works
	 ...
	 * @see XCHtml::errorSummary
	 */
	public function errorSummary($models,$header=null,$footer=null,$htmlOptions=array())
	{
		if(!$this->enableAjaxValidation && !$this->enableClientValidation)
			return XCHtml::errorSummary($models,$header,$footer,$htmlOptions);

		if(!isset($htmlOptions['id']))
			$htmlOptions['id']=$this->id.'_es_';
		$html=XCHtml::errorSummary($models,$header,$footer,$htmlOptions);
		if($html==='')
		{
			if($header===null)
				$header='<p>'.Yii::t('yii','Please fix the following input errors:').'</p>';
			if(!isset($htmlOptions['class']))
				$htmlOptions['class']=XCHtml::$errorSummaryCss;
			$htmlOptions['style']=isset($htmlOptions['style']) ? rtrim($htmlOptions['style'],';').';display:none' : 'display:none';
			$html=XCHtml::tag('div',$htmlOptions,$header."\n<ul><li>dummy</li></ul>".$footer);
		}
	 ...
	 * This method is a wrapper of {@link XCHtml::activeLabel}.
	 * Please check {@link XCHtml::activeLabel} for detailed information
	...
	{
		return XCHtml::activeLabel($model,$attribute,$htmlOptions);
	}

	/**
	 * Renders an HTML label for a model attribute.
	 * This method is a wrapper of {@link XCHtml::activeLabelEx}.
	 * Please check {@link XCHtml::activeLabelEx} for detailed information
	 * about the parameters for this method.
	 * @param CModel $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes.
	...
	{
		return XCHtml::activeLabelEx($model,$attribute,$htmlOptions);
	}

	/**
	 * Renders a url field for a model attribute.
	 * This method is a wrapper of {@link XCHtml::activeUrlField}.
	 * Please check {@link XCHtml::activeUrlField} for detailed information
	 * about the parameters for this method.
	 * @param CModel $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes.
	...
	{
		return XCHtml::activeUrlField($model,$attribute,$htmlOptions);
	}

	/**
	 * Renders an email field for a model attribute.
	 * This method is a wrapper of {@link XCHtml::activeEmailField}.
	 * Please check {@link XCHtml::activeEmailField} for detailed information
	 * about the parameters for this method.
	 * @param CModel $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes.
	...
	{
		return XCHtml::activeEmailField($model,$attribute,$htmlOptions);
	}

	/**
	 * Renders a number field for a model attribute.
	 * This method is a wrapper of {@link XCHtml::activeNumberField}.
	 * Please check {@link XCHtml::activeNumberField} for detailed information
	 * about the parameters for this method.
	 * @param CModel $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes.
	...
	{
		return XCHtml::activeNumberField($model,$attribute,$htmlOptions);
	}

	/**
	 * Generates a range field for a model attribute.
	 * This method is a wrapper of {@link XCHtml::activeRangeField}.
	 * Please check {@link XCHtml::activeRangeField} for detailed information
	 * about the parameters for this method.
	 * @param CModel $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes.
	...
	{
		return XCHtml::activeRangeField($model,$attribute,$htmlOptions);
	}

	/**
	 * Renders a date field for a model attribute.
	 * This method is a wrapper of {@link XCHtml::activeDateField}.
	 * Please check {@link XCHtml::activeDateField} for detailed information
	 * about the parameters for this method.
	 * @param CModel $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes.
	...
	{
		return XCHtml::activeDateField($model,$attribute,$htmlOptions);
	}

	/**
	 * Renders a text field for a model attribute.
	 * This method is a wrapper of {@link XCHtml::activeTextField}.
	 * Please check {@link XCHtml::activeTextField} for detailed information
	 * about the parameters for this method.
	 * @param CModel $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes.
	...
	{
		return XCHtml::activeTextField($model,$attribute,$htmlOptions);
	}

	/**
	 * Renders a hidden field for a model attribute.
	 * This method is a wrapper of {@link XCHtml::activeHiddenField}.
	 * Please check {@link XCHtml::activeHiddenField} for detailed information
	 * about the parameters for this method.
	 * @param CModel $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes.
	...
	{
		return XCHtml::activeHiddenField($model,$attribute,$htmlOptions);
	}

	/**
	 * Renders a password field for a model attribute.
	 * This method is a wrapper of {@link XCHtml::activePasswordField}.
	 * Please check {@link XCHtml::activePasswordField} for detailed information
	 * about the parameters for this method.
	 * @param CModel $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes.
	...
	{
		return XCHtml::activePasswordField($model,$attribute,$htmlOptions);
	}

	/**
	 * Renders a text area for a model attribute.
	 * This method is a wrapper of {@link XCHtml::activeTextArea}.
	 * Please check {@link XCHtml::activeTextArea} for detailed information
	 * about the parameters for this method.
	 * @param CModel $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes.
	...
	{
		return XCHtml::activeTextArea($model,$attribute,$htmlOptions);
	}

	/**
	 * Renders a file field for a model attribute.
	 * This method is a wrapper of {@link XCHtml::activeFileField}.
	 * Please check {@link XCHtml::activeFileField} for detailed information
	 * about the parameters for this method.
	 * @param CModel $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes
	...
	{
		return XCHtml::activeFileField($model,$attribute,$htmlOptions);
	}

	/**
	 * Renders a radio button for a model attribute.
	 * This method is a wrapper of {@link XCHtml::activeRadioButton}.
	 * Please check {@link XCHtml::activeRadioButton} for detailed information
	 * about the parameters for this method.
	 * @param CModel $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes.
	...
	{
		return XCHtml::activeRadioButton($model,$attribute,$htmlOptions);
	}

	/**
	 * Renders a checkbox for a model attribute.
	 * This method is a wrapper of {@link XCHtml::activeCheckBox}.
	 * Please check {@link XCHtml::activeCheckBox} for detailed information
	 * about the parameters for this method.
	 * @param CModel $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes.
	...
	{
		return XCHtml::activeCheckBox($model,$attribute,$htmlOptions);
	}

	/**
	 * Renders a dropdown list for a model attribute.
	 * This method is a wrapper of {@link XCHtml::activeDropDownList}.
	 * Please check {@link XCHtml::activeDropDownList} for detailed information
	 * about the parameters for this method.
	 * @param CModel $model the data model
	 * @param string $attribute the attribute
	...
	{
		return XCHtml::activeDropDownList($model,$attribute,$data,$htmlOptions);
	}

	/**
	 * Renders a list box for a model attribute.
	 * This method is a wrapper of {@link XCHtml::activeListBox}.
	 * Please check {@link XCHtml::activeListBox} for detailed information
	 * about the parameters for this method.
	 * @param CModel $model the data model
	 * @param string $attribute the attribute
	 * @param array $data data for generating the list options (value=>display)
	...
	{
		return XCHtml::activeListBox($model,$attribute,$data,$htmlOptions);
	}

	/**
	 * Renders a checkbox list for a model attribute.
	 * This method is a wrapper of {@link XCHtml::activeCheckBoxList}.
	 * Please check {@link XCHtml::activeCheckBoxList} for detailed information
	 * about the parameters for this method.
	 * @param CModel $model the data model
	 * @param string $attribute the attribute
	...
	{
		return XCHtml::activeCheckBoxList($model,$attribute,$data,$htmlOptions);
	}

	/**
	 * Renders a radio button list for a model attribute.
	 * This method is a wrapper of {@link XCHtml::activeRadioButtonList}.
	 * Please check {@link XCHtml::activeRadioButtonList} for detailed information
	 * about the parameters for this method.
	 * @param CModel $model the data model
	 * @param string $attribute the attribute
	...
	{
		return XCHtml::activeRadioButtonList($model,$attribute,$data,$htmlOptions);
	}
	...
	public static function validate($models, $attributes=null, $loadInput=true)
	{
		...
		foreach($models as $model)
		{
			...
			foreach($model->getErrors() as $attribute=>$errors)
				$result[XCHtml::activeId($model,$attribute)]=$errors;
		}
	...
	public static function validateTabular($models, $attributes=null, $loadInput=true)
	{
		...
		foreach($models as $i=>$model)
		{
			...
			$model->validate($attributes);
			foreach($model->getErrors() as $attribute=>$errors)
				$result[XCHtml::activeId($model,'['.$i.']'.$attribute)]=$errors;
		}
		return function_exists('json_encode') ? json_encode($result) : CJSON::encode($result);
	}
}